...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { age: @computer.age, gender: @computer.gender, name: @computer.name, place: @computer.place } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { age: @computer.age, gender: @computer.gender, name: @computer.name, place: @computer.place } }
